...
public class GameControllerTest {
    ...
    @Test
    public void test_FirstHandThreeTercias() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.SPADE, 2));
        ...
        assertTrue(gameController.checkHandForWinCondition(threeTercias, 6));
    }

    @Test
    public void test_FirstHandTwoTerciasWithJoker() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.SPADE, 2));
        ...
        Hand twoTerciasWithJoker = new Hand(cards);

        assertTrue(gameController.checkHandForWinCondition(twoTerciasWithJoker, 6));
    }

    @Test
    public void test_FirstHandTwoTerciasWithTwoJokers() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.JOKER, -1));
        cards.add(new Card(Suit.JOKER, -1));
        cards.add(new Card(Suit.HEART, 2));
        ...
        Hand twoTerciasWithTwoJokers = new Hand(cards);

        assertTrue(gameController.checkHandForWinCondition(twoTerciasWithTwoJokers, 6));
    }

    @Test
    public void test_twoJokersWithNoPairs() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.JOKER, -1));
        cards.add(new Card(Suit.JOKER, -1));
        cards.add(new Card(Suit.HEART, 2));
        ...
        Hand noPairsTwoJokers = new Hand(cards);

        assertFalse(gameController.checkHandForWinCondition(noPairsTwoJokers, 6));
    }
    ...
    @Test
    public void test_roundSixTwoPerfectTercias() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.SPADE, 2));
    ...
    @Test
    public void test_roundSixOnePerfectTercia() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.SPADE, 2));
    ...
    @Test
    public void test_roundSixNoTercias() {
        ArrayList<Card> cards = new ArrayList<>();
    ...
    @Test
    public void test_roundSixThreeOverPerfectTercias() {
        ArrayList<Card> cards = new ArrayList<>();
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.HEART, 2));
        cards.add(new Card(Suit.SPADE, 2));
